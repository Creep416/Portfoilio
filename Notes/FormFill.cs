	...
	public partial class FormFill : Form
	{
		...
		private void saveButton_Click(object sender, EventArgs e)
		{
			if (textName.Text != "")
			{
				...
				using (StreamWriter writer = new StreamWriter("C:\\Users\\Creep\\source\\repos\\Portfoilio\\Notes\\Base\\Base.txt", true))
				{
					writer.WriteLine(count + ";" + name + ";" + text);
				}
				pictureBox1.Image.Save(@"C:\Users\Creep\source\repos\Portfoilio\Notes\Base\images\" + textName.Text + "1.jpg");
				pictureBox2.Image.Save(@"C:\Users\Creep\source\repos\Portfoilio\Notes\Base\images\" + textName.Text + "2.jpg");
				pictureBox3.Image.Save(@"C:\Users\Creep\source\repos\Portfoilio\Notes\Base\images\" + textName.Text + "3.jpg");
				pictureBox4.Image.Save(@"C:\Users\Creep\source\repos\Portfoilio\Notes\Base\images\" + textName.Text + "4.jpg");
				this.Close();
			}
		}
